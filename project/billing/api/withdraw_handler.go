...
func WithdrawHandler(accountRepo account.Repository, ledger legder.Ledger) func(c *gin.Context) {
	type Body struct {
	...
	return func(c *gin.Context) {
		...
		transaction := ledger.NewTransaction("withdraw")
		transaction.AddEntry(userAccount, 1, body.Amount)
		transaction.AddEntry(cashbook, 2, body.Amount)
